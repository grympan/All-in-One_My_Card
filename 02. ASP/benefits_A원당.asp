...
<body>
<br/><br/><br/><br/>
<center><span style="color:white"><font size ="5"><%=session("ID") %> 님의 N원당 결제시 혜택입니다.
<br/><br/>
...
<%
  ...
  sql="select 카드번호, 카드명, 혜택내용, 혜택한도, 혜택방식, A금액, A혜택액 from 보유카드, 카드종류, 제공, 혜택, A원당 where A원당.혜택번호=혜택.혜택번호 and 혜택.혜택번호=제공.혜택번호 and 제공.카드식별코드=카드종류.카드식별코드 and 제공.카드사번호=카드종류.카드사번호 and 카드종류.카드식별코드=보유카드.카드식별코드 and 카드종류.카드사번호=보유카드.카드사번호 and id='" & session("ID") & "'"
  Set rs=Dbcon.Execute(sql)
	...
	do while not(Rs.Eof)
		...
		response.write("<td>" & Rs("A금액") & "원당 " & Rs("A혜택액") & "원 " & Rs("혜택방식") & "</td>")
